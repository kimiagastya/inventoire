...
3. Mengapa JSON sering digunakan dalam pertukaran data antara aplikasi web modern? <br>
  ...
  2. Sintaks JSON mudah digunakan dan sangat ringan untuk diproses sehingga lebih cepat dalam merespon dan mengeksekusi request client.
  3. Semua browser dan sistem operasi kompatibel dengan JSON. Semua browser dan bahasa pemrograman memiliki parser JSON.
